    ...
    while(t--)
    {
        ...
        else
        {
               ...
               //  cout<<"TEMP prev "<<temp<<endl;
                ...
                if(temp!='x')
                {
                   // cout<<"TEMP "<<temp<<endl;
                    ...
                    {
                        if(s[j]=='?') s[j]=temp;
                        else if(s[j]!='?' and s[j]==temp) {}
                        else if(s[j]!='?' and s[j]!=temp) {flag=false;
                       // cout<<temp<<" "<<s[j]<<endl;
          ...
          // cout<<"STRING "<<s<<endl;
            ...
            if(on>k/2 or zr>k/2) { flag=false;
            // cout<<"AIKHANE 2 "<<endl;
             }
