...
void update1(ll node,ll b,ll e,ll i,ll value)
{
    ...
    ll right=(2*node)+1;
    ll mid=(b+e)/2;
    update1(left,b,mid,i,value);
    update1(right,mid+1,e,i,value);
...
int main()
{
    ...
    while(q--)
    {
        ...
        {
            ll idx,value;
            scanf("%lld %lld",&idx,&value);
            update1(1,1,n,idx+1,value);

        }
        else if(x==3)
        {
            ll idx1,idx2;
            scanf("%lld %lld",&idx1,&idx2);
            printf("%lld\n",query(1,1,n,idx1+1,idx2+1));
        }
