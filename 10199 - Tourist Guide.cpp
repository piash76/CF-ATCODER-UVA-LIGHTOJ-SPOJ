...
///https://www.youtube.com/watch?v=iGGolqb6gDE&list=PL2q4fbVm1Ik6DCzm9XZJbNwyHtHGclcEh&index=26
...
///if in[node]>=low[child] then there must be grand parent which is connected via node and also child
ll n,m;
vector<ll> g[maxn];
ll vis[maxn],in[maxn],low[maxn];
ll timer,bridgecnt;
bool found;
bool isarti[maxn];
map<string,ll> city;
...
void dfs(ll node,ll par=-1)
{
    ...
    if(par==-1 and cntchild>1) isarti[node]=true;
}
...
bool visited[100000];
int dis[100000],fin[100000],low[100000],child[100000],parent[100000],tim=0;
int nodes[100000]={0},total=0;
set<string>st;
